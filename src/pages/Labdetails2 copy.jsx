                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="modal-product-info shop-details-info pl-0">
                                    ...
                                    <h1 style={{fontSize:'45px',color:'black',fontFamily:'inherit',fontWeight:'bold'}}>GENOTICS LABS</h1>
                                    <div className="product-price">
                                        <p style={{color:'#0a9a73',fontSize:'25px'}}>Kannur,Caltex</p>
                                        <p style={{fontWeight:'bold',fontFamily:'inherit',color:'black',fontSize:'15px',marginTop:'-5px',letterSpacing:'1px',}}>Email:Genoticslabs@gmail.com</p>
                                ...
                                <li>
                                    <div className="top-rated-product-item clearfix">
                                        <div className="top-rated-product-img">
                                            <a href="product-details.html"><img src="img/photos/doctors3.jpg" alt="#"/></a>
                                        </div>
                                        <div className="top-rated-product-info">
                                            ...
                                            <h6><a style={{color:'black',fontFamily:'inherit',fontWeight:'bold',fontSize:'18px',marginLeft:'6%'}} href="product-details.html">Dr.Olivia Ann</a></h6>
                                            <div className="product-price">
                                ...
                                <li>
                                    <div className="top-rated-product-item clearfix">
                                        ...
                                        <div className="top-rated-product-info">
                                            ...
                                            <h6><a style={{color:'black',fontFamily:'inherit',fontWeight:'bold',fontSize:'18px',marginLeft:'6%'}} href="product-details.html">Dr.Rajesh M</a></h6>
                                            <div className="product-price">
                                                <img src='img/photos/medi.png' style={{maxWidth:'12px',marginRight:'5px',marginBottom:'3px',fontFamily:'inherit'}}/>Consultant Microbiologist    
                                                <p style={{fontSize:'12px',color:'teal',fontFamily:'inherit',marginLeft:'4%'}}>MBBS,MD,PGDHHM,FAACC</p>                                        
                                            </div>
                                ...
                                <li>
                                    <div className="top-rated-product-item clearfix">
                                        ...
                                        <div className="top-rated-product-info">
                                           ...
                                           <h6><a style={{color:'black',fontFamily:'inherit',fontWeight:'bold',fontSize:'18px',marginLeft:'6%'}} href="product-details.html">Dr.Nivedika</a></h6>
                                            <div className="product-price">
                                                <img src='img/photos/medi.png' style={{maxWidth:'12px',marginRight:'5px',marginBottom:'3px',fontFamily:'inherit'}}/>Consultant Microbiologist    
                                                <p style={{fontSize:'12px',color:'teal',fontFamily:'inherit',marginLeft:'4%'}}>MBBS,MD,PGDHHM,FAACC</p>                                        
                                            </div>
