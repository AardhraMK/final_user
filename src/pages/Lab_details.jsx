                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="ltn__shop-details-img-gallery">
                                    <div className="ltn__shop-details-large-img">
                                        ...
                                        <div className="single-large-img">
                                            <a href="img/photos/webdetails8.webp" data-rel="lightcase:myCollection">
                                                <img src="img/photos/webdetails8.webp" alt="Image"/>
                                            </a>
                                        </div>
                                        <div className="single-large-img">
                            ...
                            <div className="col-md-6">
                                <div className="modal-product-info shop-details-info pl-0">
                                    ...
                                    <h1 style={{fontSize:'42px'}}>GENOTICS LABS</h1>
                                    <div className="product-price">
                                        <p>Kannur,Caltex</p>
                                        <p style={{color:'gray',fontSize:'15px',lineHeight:'0.2',letterSpacing:'1px'}}>Email:Genoticslabs@gmail.com</p>
                                        <p style={{color:'gray',fontSize:'15px',lineHeight:'0.2',letterSpacing:'1px'}}>Phone:9167348902</p>
                                        <div className="ltn__social-media" style={{color:'gray',fontSize:'15px',marginTop:'-5px',letterSpacing:'1px'}}>
                                        <ul>
                                            <li>Share:</li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#" className="" title="Wishlist" data-bs-toggle="modal" data-bs-target="#liton_wishlist_modal">
                                                    ...
                                                    <span style={{marginBottom:'2px'}}>Add to Wishlist</span>
                                                </a>
                                            </li>
                                            {/* <li>
                                    ...
                                    <hr/>
                                    <div className="ltn__safe-checkout" style={{marginTop:'-10px'}}>
                        ...
                        <div className="tab-content">
                            <div className="tab-pane fade active show" id="liton_tab_details_1_1">
                                <div className="ltn__shop-details-tab-content-inner">
                                    <h4 className="title-2">Highly equipped with latest laboratory machines to perform routine as well as advanced tests.</h4>
                                    <p>DVA diagnostics pathology laboratory doctor and medical staff has diligently provided quality laboratory services to its patients, customers and to medical community in Mulund and nearby suburbs. </p> 
                                    <p>We remain committed today in providing accurate diagnostic test results and exceptional support services . Our values- Commit to service excellence Trust each other with respect and honesty Demonstrate responsibility and accountability Maintain confidentiality Be enthusiastic and continues improvement Vision - to provide every patient or customer with world class diagnostic pathological services easily accessible and affordable Mission-To become worldclass laboratory with technologies on par with international standards.</p>
                                </div>
                            </div>
                ...
                <div className="col-lg-4">
                    <aside className="sidebar ltn__shop-sidebar ltn__right-sidebar">
                        ...
                        <div className="widget ltn__top-rated-product-widget">
                            <h4 className="ltn__widget-title ltn__widget-title-border">SPECIALISED DOCTORS</h4>
                            <ul>
                                <li>
                                    <div className="top-rated-product-item clearfix">
                                        ...
                                        <div className="top-rated-product-info">
                                            ...
                                            <h6><a href="product-details.html">Dr.Olivia Ann</a></h6>
                                            <div className="product-price">
                                                <img src='img/photos/medi.png' style={{maxWidth:'12px',marginRight:'5px',marginBottom:'3px'}}/>Consultant Microbiologist    
                                                <p style={{fontSize:'12px'}}>MBBS,MD,PGDHHM,FAACC</p>                                        
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div className="top-rated-product-item clearfix">
                                        ...
                                        <div className="top-rated-product-info">
                                            ...
                                            <h6><a href="product-details.html">Dr.Jeremy Crew</a></h6>
                                            <div className="product-price">
                                                <img src='img/photos/medi.png' style={{maxWidth:'12px',marginRight:'5px',marginBottom:'3px'}}/>Consultant Pathologist    
                                                <p style={{fontSize:'12px'}}>MBBS,MD,PGDHHM,FAACC</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div className="top-rated-product-item clearfix">
                                        ...
                                        <div className="top-rated-product-info">
                                            ...
                                            <h6><a href="product-details.html">Dr.Olivia Baker</a></h6>
                                            <div className="product-price">
                                                <img src='img/photos/medi.png' style={{maxWidth:'12px',marginRight:'5px',marginBottom:'3px'}}/>Consultant Serologist    
                                                <p style={{fontSize:'12px'}}>MBBS,MD,PGDHHM,FAACC</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div  className="widget ltn__banner-widget"style={{marginTop:'40%'}}>
                            <a href="shop.html"><img src="img/photos/big.png" alt="#"/></a>
                        </div>
                    </aside>
                </div>
            </div>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="section-title-area ltn__section-title-2">
                        <h1 className="title-2" style={{fontSize:'35px'}}>HEALTH PACKAGES</h1>
                    </div>
                </div>
            </div>
            <div className="row ltn__related-product-slider-one-active slick-arrow-1" style={{position: "relative",top: "-20px"}}>
                ...
                <div className="col-lg-12">
                    <div className="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <a href="product-details.html"><img src="img/photos/patient.webp" style={{height:'310px'}} alt="#"/></a>
                ...
                <div className="col-lg-12">
                    <div className="ltn__product-item ltn__product-item-3 text-center">
                        <div className="product-img">
                        <a href="product-details.html"><img src="img/photos/postnatal1.jpg"style={{width:'600px',height:'310px'}} alt="#"/></a>
                            {/* <div className="product-badge">
                                <ul>
                                    <li className="sale-badge">New</li>
                                </ul>
                ...
                <div className="col-lg-12">
                    <div className="ltn__product-item ltn__product-item-3 text-center">
                        <div className="product-img">
                        <a href="product-details.html"><img src="img/photos/postnatal.jpg" style={{height:'310px'}} alt="#"/></a>
                            {/* <div className="product-badge">
                                <ul>
                                    <li className="sale-badge">New</li>
                                </ul>
                ...
                <div className="col-lg-12">
                    <div className="ltn__product-item ltn__product-item-3 text-center">
                        <div className="product-img">
                        <a href="product-details.html"><img src="img/photos/women.jpg" style={{height:'310px'}} alt="#"/></a>
                            {/* <div className="product-badge">
                                <ul>
                                    <li className="sale-badge">New</li>
                                </ul>
                ...
                <div className="col-lg-12">
                    <div className="ltn__product-item ltn__product-item-3 text-center">
                        <div className="product-img">
                        <a href="product-details.html"><img src="img/photos/men.png" style={{height:'310px'}} alt="#"/></a>
                            {/* <div className="product-badge">
                                <ul>
                                    <li className="sale-badge">New</li>
                                </ul>
                ...
                <div className="col-lg-12">
                    <div className="ltn__product-item ltn__product-item-3 text-center">
                        <div className="product-img">
                        <a href="product-details.html"><img src="img/photos/fitness.jpg"  style={{height:'310px'}} alt="#"/></a>
                            {/* <div className="product-badge">
                                <ul>
                                    <li className="sale-badge">New</li>
                                </ul>
...
<div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title-area ltn__section-title-2">
                        <h1 className="title-2" style={{fontSize:'35px'}}>SPECIAL TESTS</h1>
                    </div>
                </div>
            </div>
            <div class="row">
